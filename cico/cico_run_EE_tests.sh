...
echo "Cloned rh-che. LS:"
ls
chmod +x ./rh-che/functional-tests/devscripts/prepare_env.sh
chmod +x ./rh-che/functional-tests/devscripts/run_tests.sh
./rh-che/functional-tests/devscripts/prepare_env.sh
./rh-che/functional-tests/devscripts/run_tests.sh
